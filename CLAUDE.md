...
- Backend: deployed via git push (Cloud Run). OpenClaw binary at `/home/ubuntu/.npm-global/bin/openclaw` on server.
...
- After plugin deploy, restart gateway: `/home/ubuntu/.npm-global/bin/openclaw gateway restart`
...
- Deploy trigger (plugin):
  ...
  # Install and build on remote (pnpm not in PATH — use full path)
  ssh ubuntu@chaz-clawd "export PATH=/home/ubuntu/.local/share/pnpm:\$PATH && cd /home/ubuntu/.openclaw/extensions/claw-clinic && pnpm install && pnpm build"
  # Restart gateway
  ssh ubuntu@chaz-clawd "/home/ubuntu/.npm-global/bin/openclaw gateway restart"
  ```
- Health check: `ssh ubuntu@chaz-clawd "/home/ubuntu/.npm-global/bin/openclaw gateway status"`
